...
try{
$SUCCESS = Remove-Item -Path ${PRINTERS_CSV_FILE} -Force -ErrorAction Stop 2>&1 | out-null
}catch{}

try{
$SUCCESS = Move-Item -Force -ErrorAction Stop -Path $TEMP_FILE_ONE -Destination ${PRINTERS_CSV_FILE} 2>&1 | out-null
}catch{}
